...
public class CharacterSetup : MonoBehaviour
{
    ...
    public GameObject CreateCharacter(Player parent, int chairNo)
    {
        ...
        SetupPlayer(newPlayer, parent, chairNo);
        return newPlayer;
    }
    public void SetupPlayer(GameObject newPlayer, Player parent, int chairNo)
    {
